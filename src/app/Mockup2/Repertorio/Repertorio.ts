...
import { BusquedaComponent } from 'src/app/components/busqueda/busqueda';
...
export class RepertorioPage implements OnInit {
  ...
  crearRepertorio() {
    this.router.navigate(['/mockup2/repertorio/crear']);
  }
  ...
  verRepertorio(repertorio: Repertorio) {
    ...
    this.router.navigate(['/mockup2/repertorio/lista']);
  }
}
